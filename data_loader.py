# Data loading and preprocessing for DAM and BM datasets.
#
# Loads raw CSV files, constructs feature matrices, and splits into
# pre-test and test sets using a rolling walk-forward scheme following
# O'Connor et al. (2025). DAM test period starts 2020-06-01; BM test
# period covers the last 1440 rows (30 days x 48 half-hourly periods).
#
