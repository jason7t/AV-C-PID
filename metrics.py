# Evaluation metrics for probabilistic electricity price forecasts.
#
# Metrics:
...
#   Cov80  : Empirical 80% coverage, target 0.80
#   Cov40  : Empirical 40% coverage, target 0.40
#   Winkler: Combined sharpness and coverage score (lower = better)
