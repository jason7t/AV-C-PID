# Battery storage trading strategies for financial performance evaluation.
#
# Implements TS1 and TS2 following O'Connor et al. (2025), using predicted
# quantile intervals to time buy and sell decisions for a simulated 1 MWh
# battery. Profit is computed on actual realized prices.
#
# Strategies:
#   TS1 : single buy-sell pair per day, dual-ordering selection
#   TS2 : bottleneck-constrained multi-trade with recursive search
#
# Battery parameters: discharge efficiency 0.80, charge efficiency 0.98,
# warm-up skip of 152 DAM prediction days.
#
