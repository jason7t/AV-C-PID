# Utility functions for the EnbPI and SPCI implementation.
#
# Provides helper functions used by SPCI_class.py, including adaptive
# miscoverage adjustment, coverage and width evaluation, rolling averages,
# and strided sliding-window construction for residual sequence modelling.
#
# Adapted from the original EnbPI utility functions by Xu and Xie (2021).
# Xu, C. and Xie, Y. (2021). Conformal Prediction Interval for Dynamic
# Time-Series. Proceedings of the 38th International Conference on
